...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onToggleAuth }) => {
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#e43827] to-[#ea6254] p-12 flex-col justify-center">
                <div className="max-w-md">
                    ...
                    <p className="text-xl text-white/90 leading-relaxed mb-8">
                        Platform API terpadu untuk skor kredit berbasis AI dan
                        identitas digital terdesentralisasi yang aman.
                    </p>
                ...
                <div className="max-w-md w-full space-y-8">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-gray-600">
                            Akses platform kredibilitas digital Anda
                        </p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                type="button"
                                className="text-sm text-[#e43827] hover:text-[#ea6254] font-medium"
                            >
                                Lupa password?
                            </button>
                        </div>
